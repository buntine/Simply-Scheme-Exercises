; At the end of the game, if the computer wins or ties, you never find out which
; square it chose for its final move. Modify the program to correct this. (Notice that this
; exercise requires you to make play-ttt-helper non-functional.)
